...
async def list_users(bot, message):
    DrBerlin_bot = await message.reply('Getting List Of Users')
    ...
    async for user in users:
        ...
        out += '\n'
    try:
        await DrBerlin_bot.edit_text(out)
...
async def list_chats(bot, message):
    DrBerlin_bot = await message.reply('Getting List Of chats')
