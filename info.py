...
API_ID = int(environ.get('API_ID', '4234473')) # API ID from my.telegram.orgdocker run --rm drbro-bot
API_HASH = environ.get('API_HASH', '6d9e82c9edc244b0c0a20d8fa89f9784')  # API Hash from my.telegram.org
BOT_TOKEN = environ.get('BOT_TOKEN', "8481088864:AAE5of3812-xW2p_Uh_JXChWVHrIgBDYhG0")    # Bot token from @BotFather
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002388027077'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002743096144'))  # Bin channel id (make sure bot is admin)
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002388027077')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002388027077')  # Request channel id (make sure bot is admin)
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', '') # Collection name (default: dreamcinezone_files)
...
SHORTENER_API = environ.get("SHORTENER_API", "9fe8e542cc79b42ef633658a8ba7fa89c5df324e") # Shortener API key
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "nanolinks.in") # Shortener website

SHORTENER_API2 = environ.get("SHORTENER_API2", "9fe8e542cc79b42ef633658a8ba7fa89c5df324e")  # Shortener API key for second website
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "nanolinks.in") # Shortener website for second website

SHORTENER_API3 = environ.get("SHORTENER_API3", "9fe8e542cc79b42ef633658a8ba7fa89c5df324e")  
