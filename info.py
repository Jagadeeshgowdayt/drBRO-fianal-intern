...
# ============================
SESSION = environ.get('SESSION', 'jagadeesh')   # Session name for the bot
...
BOT_TOKEN = environ.get('BOT_TOKEN', "8281550081:AAGS2m5jW4gmQ21dd82ic3tEbJM7Uxnd750")    # Bot token from @BotFather
...
PICS = (environ.get('PICS', 'https://envs.sh/b99.png')).split()  # Sample pic
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002832393534')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002832393534')  # Request channel id (make sure bot is admin)
...
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'ɴᴏ ᴀᴠᴀɪʟᴀʙʟᴇ ʀɪɡʜᴛ ɴᴏᴡ')    # Owner UPI ID for payments
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://jagadeesh:jagadeesh@jagadeesh.i5ahqij.mongodb.net/?retryWrites=true&w=majority&appName=jagadeesh")  # MongoDB URI for the database
DATABASE_NAME = environ.get('DATABASE_NAME', "jagadeesh") # Database name (default: cluster)
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'jagadeesh') # Collection name (default: dreamcinezone_files)
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002388027077'))  # Notification of sent to your channel
...
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/DrBerlin_bot")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/DrBerlin_bot")   # Third tutorial link for verification

# Verification (Must Fill All Veriables. Else You Got Error
SHORTENER_API = environ.get("SHORTENER_API", "78bd933962e1b9957fab3439d348275bb20e31d1") # Shortener API key
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "adrinolinks.in") # Shortener website

SHORTENER_API2 = environ.get("SHORTENER_API2", "78bd933962e1b9957fab3439d348275bb20e31d1")  # Shortener API key for second website
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "adrinolinks.in") # Shortener website for second website

SHORTENER_API3 = environ.get("SHORTENER_API3", "78bd933962e1b9957fab3439d348275bb20e31d1")  
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/DrBerlin_bot') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/DrBerlin_bot') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/DrBerlin_bot') # Update channel link for the bot
...
SESSION_NAME = str(environ.get('SESSION_NAME', 'DrBerlin_bot'))
MULTI_CLIENT = False
name = str(environ.get('name', 'DrBerlin_bot'))
